      ...
      <div className="flex items-center justify-between px-4 md:px-20 py-2 md:py-4 max-w-7xl mx-auto w-full">
        ...
        >
          ...
          <div>
            <h1 className="font-display font-extrabold text-sm md:text-xl text-charcoal-dark tracking-tight leading-none">
              <span className="md:hidden">BK Unila</span>
              <span className="hidden md:inline">Ruang Aman BK Unila</span>
            </h1>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            id="btn-panic-header"
          >
            <span className="md:hidden w-10 h-10 rounded-full bg-coral-pink flex items-center justify-center border border-[#ffa8a1] shadow-sm hover:shadow">
              <ShieldAlert className="w-5 h-5 fill-coral-panic text-coral-panic" />
            </span>
            <span className="hidden md:flex items-center gap-2 bg-coral-pink hover:bg-[#ffc6c1] text-coral-dark-text font-semibold text-xs rounded-full px-5 py-3 shadow-sm border border-[#ffa8a1]">
